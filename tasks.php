...
function renderTaskAuditHistoryHtml(array $entries): string {
  ...
  return '<div class="task-audit-history-shell" tabindex="0" aria-label="Task audit history panel">'
    ...
    . '</div>'
    . '<div class="js-audit-cheatline" style="display:none;font-size:10px;color:#334155;background:#f1f5f9;border:1px solid #e2e8f0;border-radius:999px;padding:2px 8px;margin:0 0 6px 0;width:max-content;">Keys: A S R C G H M Shift+M ? Esc</div>'
    ...
    . '<div class="js-audit-source-legend" style="display:block;font-size:10px;color:#64748b;margin:0 0 6px 0;">Legend: <span style="display:inline-flex;align-items:center;gap:3px;"><span style="width:7px;height:7px;border-radius:999px;background:#0f766e;display:inline-block;"></span>Keyboard</span> <span style="display:inline-flex;align-items:center;gap:3px;margin-left:8px;"><span style="width:7px;height:7px;border-radius:999px;background:#1d4ed8;display:inline-block;"></span>Button</span> <span style="display:inline-flex;align-items:center;gap:3px;margin-left:8px;"><span style="width:7px;height:7px;border-radius:999px;background:#7c3aed;display:inline-block;"></span>Session</span></div>'
...
(function () {
  ...
  function wireAuditHistoryFilters(scope) {
    ...
    root.querySelectorAll('.task-audit-history-shell').forEach(function (shell) {
      ...
      const shortcutHintCompactText = 'Shortcuts: A S R C G H M Shift+M ? Esc';
      const shortcutHintDetailedText = 'Shortcuts: A = All Events, S = Status Changes, R = Reset view, C = Clear overrides, G = Global mode, H = Hint detail, Shift+H = Compact, M = Toast mute, Shift+M = Unmute';
      ...
      function sourceTooltipText(sourceLabel) {
        if (sourceLabel === 'Keyboard') {
          return 'Keyboard: changed with panel shortcuts (A/S/R/C/G/H/M/Shift+M/?/Esc).';
        }
        if (sourceLabel === 'Button') {
